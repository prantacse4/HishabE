                                ...
                                <div class="card-header bg-secondary">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="{{ route('admin.addcustomer') }}" class="btn btn-success text-right addbtn">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    onclick="event.preventDefault();document.getElementById('form-delete-id-{{ $customer->id }}').submit();">
                                                        <i class="fa fa-trash-alt"></i>
                                                    </button>
                                                    <form id="{{ 'form-delete-id-'.$customer->id }}" action="{{route('admin.deletecustomer',$customer->id)}}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('delete')
                                                        </form>
                                                </td>
