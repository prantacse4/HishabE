            ...
            <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="#" class="btn btn-success text-right addbtn">
                                    <span> Records</span>
                                </a>
                            </div>
                    </div>
                                    ...
                                    <div class="mr-auto p-2">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input class="form-control" value="<?php echo date("d / m / Y"); ?>" readonly></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Sale Type</th>
                                                        <td>
                                                        <select name="sale_type" class="form-control  sale_type select2 select2-info" style="width:100%;" id="test" onchange="f()">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <input class="form-control" type="text" readonly placeholder="Total Amount" id="upTotalAmount" value="0">
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
...
//-------------- COMPLETED ADD PRODUCT TO SELL TABLE WITH VALIDATION------------//
        ...
        <script src="{{asset('backend_assets/js/addCustomer.js')}}"></script>
        @endsection
